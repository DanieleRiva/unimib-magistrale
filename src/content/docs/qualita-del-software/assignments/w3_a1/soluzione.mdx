...
import tracciaImg from './traccia.webp';

export const templateUrl = `${import.meta.env.BASE_URL.replace(/\/$/, '')}/assignments/w3_a1/W3.A1.template.xlsx`;
...
<details open>
  <summary><strong>Template fornito (XLSX)</strong></summary>
  <p style={{ marginTop: '1rem' }}>
    <a href={templateUrl} download="W3.A1.template.xlsx">Scarica W3.A1.template.xlsx</a>
  </p>
</details>
